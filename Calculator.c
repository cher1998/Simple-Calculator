#include<reg51.h>
void calclogic(int *x,int *y,char *c);
...
void lcdinit();
char scan_key(void);
unsigned char s[]={"FIRST NO: "};
unsigned char s1[]={"SECOND NO: "};
...
void lcdinit(){
   MSDelay(15000);lcdcmd(0x30);
   MSDelay(4500);lcdcmd(0x30);
   MSDelay(300);lcdcmd(0x30);
   MSDelay(600);
   lcdcmd(0x38);lcdcmd(0x0F);lcdcmd(0x01);lcdcmd(0x06);lcdcmd(0x80);
}
void calclogic(int *x,int *y,char *c)
  {
   switch(*c)
...
char scan_key()
{
	unsigned char c;
	c='s';
	while(!(c=='0' && c=='1' &&  c=='2' && c=='3' && c=='4' && c=='5' && c=='6' && c=='7' && c=='8' && c=='9' && c=='+' && c=='-' && c=='#' && c=='$' && c=='*' && c=='/' ))
	{
  r0=0;r1=1;r2=1;r3=1;
